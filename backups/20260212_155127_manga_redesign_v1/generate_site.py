        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-slate-100">
            ...
            <div class="bg-slate-50 border-t border-slate-100 p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-4">
                    <img src="images/mascot_tab.png" alt="Mascot" class="w-20 h-20 object-contain hover:rotate-12 transition duration-300">
                    <img src="images/mascot_thumbsup.png" alt="Mascot" class="w-20 h-20 object-contain hover:-rotate-12 transition duration-300">
                </div>
            </div>
        </div>
...
popular_html = ""
if popular_items:
    pop_list = "".join([f'<li><a href="{i["id"]}.html" class="block p-4 rounded-xl border border-transparent hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 transition flex items-start group"><span class="mr-3 text-blue-500 font-bold font-manga mt-0.5 group-hover:scale-125 transition">Q.</span><span class="font-medium">{html.escape(i["question"])}</span></a></li>' for i in popular_items])
    popular_html = f"""
    <section class="mb-16">
        <div class="bg-white border-2 border-slate-100 rounded-3xl p-8 shadow-sm">
            <h2 class="text-slate-800 font-bold text-xl mb-6 flex items-center manga-font">
...
for svc_name in sorted_services:
    svc_html = f'<section class="mb-20"><h2 class="flex items-center text-2xl font-bold text-slate-900 mb-8 manga-font"><span class="w-4 h-8 bg-blue-500 mr-4 skew-x-[-15deg] rounded-sm"></span>{html.escape(svc_name)}</h2>'
...
<body class="bg-slate-50 text-slate-800 antialiased">
    <!-- Header: Manga Style Redesign -->
    <header class="bg-gradient-to-br from-blue-600 to-blue-700 text-white relative overflow-hidden pt-16 pb-24 shadow-2xl">
        <!-- Floating shapes -->
        ...
        <div class="max-w-6xl mx-auto px-4 relative z-10 text-center">
            ...
            <div class="mb-10 flex flex-col items-center justify-center">
                <img src="images/sunnet_logo_orig.png" alt="Sun-Net Logo" class="h-16 mb-4 brightness-0 invert object-contain drop-shadow-md">
                <div class="relative">
                    ...
                    <!-- Mascot integration -->
                    <div class="absolute -top-12 -left-28 hidden lg:block scale-150 transform -rotate-12 drop-shadow-2xl">
                        <img src="images/mascot_thumbsup.png" alt="Thumbs Up" class="w-32 h-32 object-contain">
                    </div>
                    <div class="absolute -bottom-8 -right-24 hidden lg:block scale-150 transform rotate-6 drop-shadow-2xl">
                        <img src="images/mascot_redman.png" alt="Redman" class="w-28 h-28 object-contain">
                    </div>
                </div>
                <p class="text-blue-100 text-lg font-bold mt-4 tracking-widest bg-blue-800/50 px-6 py-1 rounded-full inline-block uppercase">Internet Support Center</p>
            </div>
            
            <!-- Google Style Search Bar -->
            <div class="max-w-2xl mx-auto mt-12 w-full">
                <div class="google-shadow bg-white rounded-full flex items-center px-4 md:px-6 py-1 md:py-2 transition duration-200 relative z-30 group">
    ...
    <main class="max-w-6xl mx-auto px-4 py-16 relative z-10">
        ...
        <div id="search-results-area" class="hidden mb-16 animate-in fade-in duration-500">
            <h2 id="search-results-title" class="text-2xl font-bold text-slate-800 mb-8 manga-font flex items-center">
    ...
    <footer class="bg-slate-900 text-slate-400 py-24 relative overflow-hidden">
        <!-- Footer mascot decorate -->
        <div class="absolute top-1/2 right-12 -translate-y-1/2 opacity-10 pointer-events-none scale-150 rotate-12">
